...
const Steps = (props) => {
  const { recipeData, setRecipeData, ingredients } = props;
    ...
    <Card>
      <Card.Body>
        ...
        {recipeData.recipe_steps.map((step, index) => {
          ...
          return (
            <>
              <h6 style={{ display: "inline", width: "10%" }}>
                {`${step.step_number}.  `}
              </h6>
              <Input
                style={{ display: "inline-block", width: "80%" }}
                name={`step_ingredients[${index}]`}
                value={recipeData.step_ingredients.recipe_source}
              ></Input>
              <br />
              <StyledSelect
              ...
              <StyledSelect
                style={{ width: "70%", margin: "0 0 0 30px" }}
